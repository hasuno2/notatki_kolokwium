/*
    ŚCIĄGAWKA C – GEOMETRIA, EPSILON, SORTOWANIE, CIĄGI
    Wszystkie zadania zapisane jako osobne fragmenty main().
    Każdy blok można odkomentować i uruchomić osobno.

    Brak funkcji.
    Wszystko pisane "pod egzamin".
*/
